<%-- 
    Document   : GuestHomeFooter
    Created on : Aug 11, 2022, 4:04:26 PM
    Author     : Angel
--%>
...
<html>
    <head>
        ...
        <title>JSP Page</title>
         <link rel="stylesheet" href="../Assets/StudentPageProperties/style-starter.css">
    </head>
    <body>
         <!-- footer -->
    <section class="w3l-footer-29-main">
        <div class="footer-29 py-5">
            <div class="container py-lg-4">
              ...
              <i class="fab fa-linkedin-in" style="color: orange;"></i>Portal
          </div>
                        </div>
