<%-- 
    Document   : Payment
    Created on : Aug 21, 2022, 8:30:32 PM
    Author     : Georgekutty
--%>
...
<html>
    ...
    <body>
        ...
        <%
            session.setAttribute("ir_id", request.getParameter("ir_id"));
            if (request.getParameter("btnsubmit") != null) {
                String update = "update tbl_request set payment_status='1'  where request_id='"+session.getAttribute("ir_id")+"'";
                        ...
                        <div class="card position-sticky top-0">
                            <div class="p-3 bg-light bg-opacity-10">
                                ...
                                <div class="d-flex justify-content-between mb-1 small">
                                    <span>Registration Fee</span> <span><i class="fas fa-rupee-sign"></i><b> <%=request.getParameter("regfee")%></b></span>
                                </div>
                                <div class="d-flex justify-content-between mb-1 small">
                                    <span>Booking Fee</span> <span><i class="fas fa-rupee-sign"></i> <b>27.33</b></span>
                                </div>
                                <div class="d-flex justify-content-between mb-1 small">
                                    <span>Coupon (Code: NEWYEAR)</span> <span class="text-danger"><i class="fas fa-rupee-sign"></i> <b>17.33</b></span>
                                </div>
                                <hr>
                                <div class="d-flex justify-content-between mb-4 small">
                                    <%
                                        String amount = request.getParameter("regfee");
                                        Double famount = Double.parseDouble(amount);
                                        Double ams = famount + 27.33 - 17.33;
                                        BigDecimal bdUp = new BigDecimal(ams).setScale(2, RoundingMode.UP);
                                        bdUp.toString();

                                    %>
                                    <span>TOTAL</span> <strong class="text-dark"><%=bdUp%></strong>
                                </div>
                                ...
                                <a href="PaymentConfirm.jsp"> <button class="btn btn-primary w-100 mt-2" type="submit" name="btnsubmit">Place order</button></a>
                            </div>
                        </div>
                    </div>
                </div>
