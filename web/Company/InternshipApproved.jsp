...
.badge-soft-primary {
    ...
    <body>
        ...
        {
            String up1="update tbl_request  set request_active='1' where request_id='"+request.getParameter("aid")+"'";
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="header-title pb-3 mt-0">Approved List</h5>
                    ...
                    while(rs1.next()){
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="InternshipApproved.jsp?did=<%=rs1.getString("internship_id")%> &aid=<%=rs1.getString("request_id")%> &semail=<%=rs1.getString("student_email")%> &sname=<%=rs1.getString("student_name")%> &cname=<%=rs1.getString("company_name")%> &iname=<%=rs1.getString("position_name")%>">
                                            <button type="submit" class="badge badge-boxed badge-success" style="border-style: none;">Completed</button>
                                        </a>
