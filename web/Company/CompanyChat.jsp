...
<html>
    <head>
        ...
        <title>InPortal::Company Chat</title>
        <style>
        ...
        <%
            if (request.getParameter("cid") != null) {
                String Update = "update tbl_chat set chat_status='1' where from_student_id='" + request.getParameter("cid") + "' and to_company_id='" + session.getAttribute("company_id") + "'";
                    ...
                    <div class="card">
                        <div class="row g-0">
                                ...
                                <div class="px-4 d-none d-md-block">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-grow-1">
                                            <input type="text" class="form-control my-3" placeholder="Search..." onkeyup="getStudent(this.value)">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-12 col-lg-7 col-xl-9">
                                <div class="py-2 px-4 border-bottom d-none d-lg-block" style="min-height: 3.4em;">
                                    <div class="d-flex align-items-center py-1">
                                        ...
                                        <div class="position-relative">
                                            <img src="../Assets/StudentPhoto//<%=comPhoto%>" class="rounded-circle mr-1" alt="Sharon Lessman" width="40" height="40">
                                        </div>
                                ...
                                <div class="position-relative" id="conversation" style="min-height: 400px;overflow: scroll;height: 400px;">
