...
<html>
    <head>
        ...
        <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.5.0/css/all.css" integrity="sha384-B4dIYHKNBt8Bc12p+WXckhzcICo0wtJAoU8YZTY5qE0Id1GSseTk6S+L3BlXeVIU" crossorigin="anonymous">
           <link href="../Assets/CompanyPageProperties/headers.css" rel="stylesheet">
    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
          <div style="font-size: xx-large;color:white;">
              <a href="CompanyHomePage2.jsp" style="cursor:pointer;"><i class="fab fa-linkedin-in" style="color: orange;"></i></a>Portal
          </div>
          ...
          <li><a href="#" class="nav-link px-2 text-white">Overview</a></li>
           ...
           <li class="nav-item dropdown">
            <a class="nav-link px-2 text-white dropdown-toggle" href="#" data-bs-toggle="dropdown" aria-expanded="false">Verification <i class="fas fa-caret-down"></i></a>
            <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="InternshipApproval.jsp">Approval</a></li>
              <li><a class="dropdown-item" href="InternshipApproved.jsp">Approved</a></li>
              <li><a class="dropdown-item" href="InternshipRejected.jsp">Rejected</a></li>
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="InternshipRegister.jsp">Register</a></li>
            
              <li><a class="dropdown-item" href="AddSyllabus.jsp">Add Syllabus</a></li>
              
            </ul>
          </li>
          <li><a href="#exampleModalScrollable" class="nav-link px-2 text-white" data-toggle="modal" data-target="#exampleModalScrollable"> 
                                    Feedback
                                    </a></li>
        </ul>
        ...
        <div class="dropdown text-end">
          <a href="#" class="nav-link px-2 text-white text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
            <img src="../Assets/CompanyLogo/<% out.print(session.getAttribute("logo"));%>" alt="mdo" width="32" height="32" class="rounded-circle">
            <i class="fas fa-caret-down"></i>
          </a>
          <ul  class="dropdown-menu text-small">
            <li><a class="dropdown-item" href="CompanyProfile.jsp"><i class="fas fa-user-circle"></i> My Profile</a></li>
            <li><a class="dropdown-item" href="CompanyChat.jsp"><i class="fas fa-comment-dots"></i> Chat</a></li>
            <li><a class="dropdown-item" href="CompanyChangePassword.jsp"><i class="fas fa-lock"></i> Change Password</a></li>
            <form method="post">
            <%
