<%-- 
    Document   : Place
    Created on : Aug 11, 2022, 12:51:20 PM
    Author     : Angel
--%>
...
.btn-success {
    ...
    background-color: #46b546 !important;
     ...
     document.getElementById("txt1").value = "--select--";
      document.getElementById("inputdistrict").value = "--select--";
    ...
    <body>
                   ...
                   <%
         String pid="",pname="",sid="",dis_id="";
         if (request.getParameter("btnsubmit") != null) {
              if(!request.getParameter("txtid").equals(""))
                {
                String sedit = "update tbl_place set district_id='"+request.getParameter("district_list")+"',place_name='"+request.getParameter("txt_place")+"' where place_id='"+request.getParameter("txtid")+"'";
         ...
         String query = "insert into tbl_place(place_name,district_id) values('" + request.getParameter("txt_place") + "','"+request.getParameter("district_list")+"')";
       ...
       String dl = "delete from tbl_place where place_id='"+request.getParameter("did")+"'";
        ...
        <!--delete code ends-->
         ...
         String sedit="select * from tbl_place p inner join tbl_district d on p.district_id=d.district_id where place_id='"+request.getParameter("eid")+"'";
        
        ResultSet rs2 = con.selectCommand(sedit);
       
        rs2.next();
        pid=rs2.getString("place_id");
        pname=rs2.getString("place_name");
        dis_id=rs2.getString("district_id");
         sid=rs2.getString("state_id");
       }
  ...
  <jsp:include page="AdminNavBar.jsp" /> 
   <div class="inner-block" >
    <div style="display: inline-flex;">
        <div>
      <form method="post" name="document" style="width: 20em;padding: 2em;"  >
          <input type="hidden" name="txtid" value="<%=pid%>">
      <fieldset>
       
        <div class="mb-3">
             
          <label  class="form-label">State</label>
          <select  class="form-control"name="state_list" id="txt1" onchange="getDistrict(this.value)" required>
            ...
            %>
              <%
                 ...
                 <option 
                     <%
                     if(rs.getString("state_id").equals(sid)){
                     out.print("Selected");
                 }
                     %>
                     value="<%=rs.getString("state_id")%>" >   
          ...
          <select  class="form-control"name="district_list" id="inputdistrict" required>
            <option selected>--select--</option>
            
              <%
            String select="select *from tbl_district d inner join tbl_state s on d.state_id=s.state_id where district_id='"+dis_id+"'";
            ResultSet rs4 = con.selectCommand(select);
            ...
            %>
              <%
                 ...
                 <option 
                     <%
                     if(rs4.getString("district_id").equals(dis_id)){
                     out.print("Selected");
                 }
                     %>
                     value="<%=rs4.getString("district_id")%>" >   
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="txt_place" value="<%=pname%>" autocomplete="off" id="txt2" required>
        </div>
          <br>
  ...
  <table id="example" class="table table-striped table-bordered" style="width: 43em;">
            ...
            sview="select *from tbl_place p inner join tbl_district d on p.district_id=d.district_id inner join tbl_state s on d.state_id=s.state_id";
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="Place.jsp?did=<%=rs1.getString("place_id")%>"><button type="button" class="btn btn-danger">Delete</button></a> <a href="Place.jsp?eid=<%=rs1.getString("place_id")%>"><button type="button" class="btn btn-primary">Edit</button></a>  
                    </td>
                </tr>
                <%
                }
...
function getDistrict(did)
{
	...
	$.ajax({
	  url:"../Assets/Ajaxpages/AjaxAdminplace.jsp?did="+did,
