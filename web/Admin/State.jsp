  ...
  <%
         ...
         if (request.getParameter("btnsubmit") != null) {
              if(!request.getParameter("txtid").equals(""))
                {
                String sedit = "update tbl_state set state_name='"+request.getParameter("txt_state")+"' where state_id='"+request.getParameter("txtid")+"'";
         ...
         String query = "insert into tbl_state(state_name) values('" + request.getParameter("txt_state") + "')";
          if (con.executeCommand(query)) {
        %>
        <script>
            alert("Data Inserted");
            window.location = "State.jsp";
        </script>
        <%
        } else {
        %>
       ...
       String dl = "delete from tbl_state where state_id='"+request.getParameter("did")+"'";
        ...
        <!--delete code ends-->
         ...
         String sedit="select * from tbl_state  where state_id='"+request.getParameter("eid")+"'";
...
<div class="inner-block" style="padding:/* 4em 2em 4em 2em!important;*/">
    <div style="display: inline-flex;">
      ...
      <fieldset>
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="txt_state" value="<%=sname%>" autocomplete="off" id="txt2" required>
        </div>
          <br>
  ...
  <table class="table table-striped table-bordered" style="width: 43em;" id="example">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="State.jsp?did=<%=rs1.getString("state_id")%>"><button type="button" class="btn btn-danger">Delete</button></a> <a href="State.jsp?eid=<%=rs1.getString("state_id")%>"><button type="button" class="btn btn-primary">Edit</button></i></a>  
                    </td>
                </tr>
                <%
                }
