...
<!--inner block end here-->
  <%
         String sid="",dname="",dis_id="";
         if (request.getParameter("btnsubmit") != null) {
              if(!request.getParameter("txtid").equals(""))
                {
                String sedit = "update tbl_district set state_id='"+request.getParameter("state_list")+"',district_name='"+request.getParameter("txt_district")+"' where district_id='"+request.getParameter("txtid")+"'";
         ...
         String query = "insert into tbl_district(district_name,state_id) values('" + request.getParameter("txt_district") + "','" + request.getParameter("state_list") + "')";
       ...
       String dl = "delete from tbl_district where district_id='"+request.getParameter("did")+"'";
        ...
        <!--delete code ends-->
         ...
         String sedit="select * from tbl_district  where district_id='"+request.getParameter("eid")+"'";
        
        ResultSet rs2 = con.selectCommand(sedit);
       
        rs2.next();
        sid=rs2.getString("state_id");
        dname=rs2.getString("district_name");
...
<div class="inner-block" >
    <div style="display: inline-flex;">
      ...
      <form method="post" name="document" style="width: 20em;padding: 2em;box-shadow: 0 4px 8px 0 rgb(0 0 0 / 20%);"  >
          <input type="hidden" value="<%=dis_id%>" name="txtid">
      <fieldset>
       
        <div class="mb-3">
             
          <label  class="form-label">State</label>
          <select  class="form-control"name="state_list" id="txt1">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="txt_district" value="<%=dname%>" autocomplete="off" id="txt2">
        </div>
          <br>
  ...
  <table id="example" class="table table-striped table-bordered" style="width: 43em;">
            ...
            sview="select * from tbl_district d inner join tbl_state s where d.state_id=s.state_id";
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="District.jsp?did=<%=rs1.getString("district_id")%>"><button type="button" class="btn btn-danger">Delete</button></a> <a href="District.jsp?eid=<%=rs1.getString("district_id")%>"><button type="button" class="btn btn-primary">Edit</button></a>  
                    </td>
                </tr>
                <%
                }
