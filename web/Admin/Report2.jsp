...
<html>
    ...
    <body>
        ...
        <select class="form-control" style="
                ...
                width: 100px;
                left: 8em;
                " onchange="getReport(this.value)">
            <option value="1">Payed</option>
            <option value="2">Not Payed</option>
        </select>
        
        
        <div class="canvas_div_pdf" style="margin-left: 7em;margin-top: 8em;" id="result">     
...
//                                                    }
     ...
     <script>
        function getReport(pid)
        {
            ...
            $.ajax({
                url: "../Assets/Ajaxpages/AjaxReport2.jsp?pid=" + pid,
