...
/* Loader*/
    ...
    <body>
       ...
       <table class="table table-striped table-bordered" style="width: 43em;" id="example">
            ...
            sview="select * from tbl_company co inner join tbl_intership i on co.company_id=i.company_id inner join tbl_request re on i.internship_id=re.internship_id inner join tbl_student st on st.student_id=re.student_id where company_vstatus='1' and request_active='1'";
