<%-- 
    Document   : AjaxReport2
    Created on : Sep 26, 2022, 3:49:34 PM
    Author     : Georgekutty
--%>
<jsp:useBean class="DB.ConnectionClass" id="con"></jsp:useBean>
<%@page import="java.sql.ResultSet"%>
<%
    if (request.getParameter("pid").equals("1")) {
%>
<table class="table table-striped table-bordered" style="width: 43em;" id="example">
    ...
    <%
        ...
        sview = "select * from tbl_request re inner join tbl_student st on re.student_id=st.student_id  inner join tbl_intership i on re.internship_id=i.internship_id where payment_status='1' ";
...
<%
    if (request.getParameter("pid").equals("2")) {
%>
<table class="table table-striped table-bordered" style="width: 43em;" id="example">
    ...
    <%
        ...
        sview = "select * from tbl_request re inner join tbl_student st on re.student_id=st.student_id  inner join tbl_intership i on re.internship_id=i.internship_id where payment_status='0' ";
