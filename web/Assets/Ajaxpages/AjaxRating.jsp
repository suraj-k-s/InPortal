...
<%
    ...
    if (request.getParameter("rating_data") != null) {
        ...
        String ins = "INSERT INTO tbl_review(user_name,user_rating,user_review,review_datetime,internship_id)"
    ...
    if (request.getParameter("action") != null) {
        ...
        String query = "SELECT * FROM tbl_review where internship_id = '" + request.getParameter("lid") + "' ORDER BY review_id DESC";
